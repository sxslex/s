...
Site estático (GitHub Pages) publicado a partir da pasta `docs/`, com o domínio configurado em `CNAME`.
...
1. Edite o HTML/CSS/JS normalmente nos arquivos-fonte (`index.html`, `p.html`, `p/index.html`, `v/index.html`, etc.) — **nunca edite direto dentro de `docs/`**, pois esse conteúdo é gerado e será sobrescrito no próximo build.
